...
import com.pxy.tutor.contact.ContactHttpClient;
...
public class LoginActivity extends UI implements OnKeyListener {
    ...
    private ClearableEditTextWithIcon registerCity;
    ...
    private void switchMode() {
        ...
        if (registerMode && !registerPanelInited) {
            ...
            registerCity=findView(R.id.city_ed);
            ...
            registerCity.setIconResource(R.drawable.city);
