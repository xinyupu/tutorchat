...
import com.pxy.tutor.common.ui.viewpager.FadeInOutPageTransformer;
import com.pxy.tutor.common.ui.viewpager.PagerSlidingTabStrip;
import com.pxy.tutor.main.adapter.MainTabPagerAdapter;
...
public class HomeFragment extends TFragment implements OnPageChangeListener, ReminderManager.UnreadNumChangedCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        PangJiao.inject(rootView,this);
        return rootView;
    }

    @OnClick(R.id.tv_current_city)
    public View.OnClickListener tv_Click=view -> {
        city();
    };
                ...
                .setOnPickListener(new OnPickListener() {
                    ...
                    public void onPick(int position, City data) {
                        if (data != null) {
                            ...
                            if (     adapter.getItem(0)  instanceof TutorFragment) {
                                ((TutorFragment) adapter.getItem(0)).onSelectCity(data.getName());
                            }
                        }
                    }
