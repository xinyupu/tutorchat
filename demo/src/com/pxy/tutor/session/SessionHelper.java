...
import com.pxy.tutor.DemoCache;
import com.netease.nim.demo.R;
import com.pxy.tutor.contact.activity.RobotProfileActivity;
import com.pxy.tutor.contact.activity.UserProfileActivity;
import com.pxy.tutor.redpacket.NIMRedPacketClient;
import com.pxy.tutor.session.action.AVChatAction;
import com.pxy.tutor.session.action.AckMessageAction;
import com.pxy.tutor.session.action.FileAction;
import com.pxy.tutor.session.action.GuessAction;
import com.pxy.tutor.session.action.RTSAction;
import com.pxy.tutor.session.action.RedPacketAction;
import com.pxy.tutor.session.action.SnapChatAction;
import com.pxy.tutor.session.action.TeamAVChatAction;
import com.pxy.tutor.session.action.TipAction;
import com.pxy.tutor.session.activity.AckMsgInfoActivity;
import com.pxy.tutor.session.activity.MessageHistoryActivity;
import com.pxy.tutor.session.activity.MessageInfoActivity;
import com.pxy.tutor.session.extension.CustomAttachParser;
import com.pxy.tutor.session.extension.CustomAttachment;
import com.pxy.tutor.session.extension.GuessAttachment;
import com.pxy.tutor.session.extension.RTSAttachment;
import com.pxy.tutor.session.extension.RedPacketAttachment;
import com.pxy.tutor.session.extension.RedPacketOpenedAttachment;
import com.pxy.tutor.session.extension.SnapChatAttachment;
import com.pxy.tutor.session.extension.StickerAttachment;
import com.pxy.tutor.session.search.SearchMessageActivity;
import com.pxy.tutor.session.viewholder.MsgViewHolderAVChat;
import com.pxy.tutor.session.viewholder.MsgViewHolderDefCustom;
import com.pxy.tutor.session.viewholder.MsgViewHolderFile;
import com.pxy.tutor.session.viewholder.MsgViewHolderGuess;
import com.pxy.tutor.session.viewholder.MsgViewHolderOpenRedPacket;
import com.pxy.tutor.session.viewholder.MsgViewHolderRTS;
import com.pxy.tutor.session.viewholder.MsgViewHolderRedPacket;
import com.pxy.tutor.session.viewholder.MsgViewHolderSnapChat;
import com.pxy.tutor.session.viewholder.MsgViewHolderSticker;
import com.pxy.tutor.session.viewholder.MsgViewHolderTip;
